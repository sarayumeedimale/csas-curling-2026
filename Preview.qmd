...
-   **Dependent Variable (**$P(Success)$): The probability of scoring $\ge 2$ points (the strategic goal of a Power Play).
-   $S_1$: Shot 1 Type (Categorical: Guard vs. Draw vs. Takeout).
-   $S_2$: Shot 2 Type (Categorical).
-   $\pi$: Pressure Level (Ordinal).
-   $S_1 \times \pi$: Interaction term to determine if specific shots perform better or worse as pressure increases.
